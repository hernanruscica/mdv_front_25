...
export const routes = [
  ...
  { path: "/panel/ubicaciones/:businessUuid", element: <ViewLocation />, private: true },
  ...
  { path: "/panel/ubicaciones/:businessUuid/dataloggers/:dataloggerId", element: <ViewDatalogger />, private: true },
  ...
  { path: "/panel/ubicaciones/:businessUuid/dataloggers/:dataloggerId/alarmas/:alarmId", element: <UnderConstruction />, private: true },//on progress
  // Alarmas routes / locations
  { path: "/panel/ubicaciones/:businessUuid/alarmas", element: <Alarms />, private: true }, //done
  { path: "/panel/ubicaciones/:businessUuid/alarmas/:alarmId", element: <UnderConstruction />, private: true },//on progress
  ...
  { path: "/panel/ubicaciones/:businessUuid/usuarios/:userId/alarmas/:alarmId", element: <UnderConstruction />, private: true }, //on progress
  ...
  { path: "/panel/ubicaciones/:businessUuid/dataloggers/:dataloggerId/canales/:channelId/alarmas/:alarmId", element: <UnderConstruction />, private: true },//on progress
